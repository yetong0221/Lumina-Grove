...
export function CartView() {
  ...
  if (cart.length === 0) {
    return (
      <div className="min-h-screen bg-lumina-cream/60 pt-8 px-6 flex flex-col items-center justify-center text-center">
  ...
  return (
    <div className="min-h-screen bg-lumina-cream/60 pt-8 pb-32 px-6">
